...
package com.mssola.summingbird.count
...
object StormRunner {
  ...
  lazy val config = new ConfigurationBuilder()
    .setOAuthConsumerKey("eufP2fBhd9v9UcR9DiEVow")
    .setOAuthConsumerSecret("vFfmnixMuCd177NK6Jyvg3s5n5Go1pSQvc0JNXyltE")
    .setOAuthAccessToken("372421016-7WtyyI9YJ3F6XN9D8FFwcBs7mTUrxJocHFLMFSgD")
    .setOAuthAccessTokenSecret("orCSzqVFLyOrThAoY4giHXANGBNSgPvk17Ns6ybtE9wBJ")
